...
const TechnologiesList = (props) => {
    ...
    const { data, meta: {links} } = technologies;
        ...
        <div className="max-w-screen-2xl mx-auto bg-white dark:bg-slate-800 overflow-hidden shadow-sm sm:rounded-lg p-4 sm:p-6">
            ...
            <div className="flex items-center gap-4 justify-start mb-2">
                ...
                <DeleteButton
                    ...
                    routeName={'technologies.destroy'}
                ...
                data.map(({id, name, slug, bg_color, logo}) => (
                    ...
                    >
                        ...
                        <div className="flex items-center justify-between gap-2">
                            <EditButton id={id} routeName={'technologies.edit'}/>
                            <DeleteButton
                                id={id}
                                routeName={'technologies.destroy'}
...
TechnologiesList.layout = page => <Authenticated children={page} title="Technologies List"/>
